...
public class CambiarSaldoActivity extends AppCompatActivity {
    ...
    Button btnVolverMenu, btnAccionCambiarSaldo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cambiar_saldo);
        ...
        btnAccionCambiarSaldo = findViewById(R.id.btnAccionCambiarSaldo);
        editTextSaldo = findViewById(R.id.editTextSaldoValor);
        ...
        btnVolverMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CambiarSaldoActivity.this, MainActivity.class);
                intent.putExtra(MainActivity.DIRECCIONIP, direccionIP);
                startActivity(intent);
            }
        }
        );
        btnAccionCambiarSaldo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
                    if (myTag == null || numeroTarjeta.isEmpty()) {
                        ...
                        cambiarDinero(numeroTarjeta, editTextSaldo.getText().toString());
    ...
    private void cambiarDinero(String numeroId, String dinero) {
        try {
            String direccion = "http://"+direccionIP+":8080/aplicacion/tarjetas/numero-dinero/"+numeroId+"/"+dinero;
